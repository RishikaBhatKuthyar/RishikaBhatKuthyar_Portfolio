      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <motion.div 
                className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md mb-8"
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.5 }}
              >
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <a href="#" className="flex items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
